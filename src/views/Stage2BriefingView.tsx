...
const suspects: SuspectData[] = [
  ...
  },
  {
    ...
    suspicion: "เป็นคนแรกที่เสนอให้โยงคดีเข้ากับความเชื่อท้องถิ่นเพราะเคยได้ฟังเรื่องเล่ามาจากนายคำปัน",
  },
  {
    id: 5,
    name: "นายประเสริฐ",
    ...
    suspicion: "อยู่ในคืนที่ 'ตุ๊' เสียชีวิตเมื่อ 2 เดือนก่อน และเป็นผู้พบศพแรกในคดีปัจจุบัน คำให้การดูวกวนเหมือนปิดบังอะไรบางอย่าง",
  }
];
